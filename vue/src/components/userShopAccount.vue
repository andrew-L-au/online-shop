    ...
    methods: {
        getShopInfo() {
            this.$axios({
                method: "get",
                //test
                // url: "https://run.mocky.io/v3/2fa5d8ef-0ac7-4c97-b40f-735107f5b00c", //无商店
                url: "https://run.mocky.io/v3/d3facc5c-64f6-4d3f-ba39-e62cb00a1902", //有商店
                data: {
                    userId: this.userId,
                }
            })
                .then(resp => {
                    ...
                    if (resp.data === '') {   //当前商户未开商店
                        ...
                        for (let i = 0; i < this.shop.commodityTypes.length; i++) {
                            this.strCommodityTypes += this.shop.commodityTypes[i];
                            this.strCommodityTypes += ' ';
                        }
